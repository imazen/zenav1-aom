...
> (`docs/archive/inter-vartx-coeff-arm-notes.md`, and via it `docs/inter/INTER-CHUNK2-HANDOFF.md`) into telling
...
- **PROGRESS 2026-07-19 cont. — the COEFF ARM IS WIRED END-TO-END; witness still PINNED (not
  ...
  Working notes: `docs/archive/inter-vartx-coeff-arm-notes.md` (updated with the chroma inter path, the
...
- **ROOT #1 — `part_sf.early_term_after_none_split` was UNPORTED. FIXED.**
  ...
  - **Localization (decode-both + ar-swapped sibling-C dump per docs/HANDOFF-TOGGLES.md / KB-3).**
...
- **PINNED (`zero_mv_p_low_cq_term_none_prune_pinned_divergent`) — the next missing C model:
  ...
  Full detail + next-rung plan: `docs/inter/INTER-CHUNK2-HANDOFF.md` §SESSION 2026-07-23.
