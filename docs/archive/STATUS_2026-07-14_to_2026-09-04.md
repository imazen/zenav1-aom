# STATUS archive — landings 2026-07-14 .. 2026-09-04

> Moved out of `STATUS.md` on 2026-09-25 so the live file holds one cycle. Every entry
> is verbatim; nothing was rewritten. KB bodies live in `docs/KNOWN_BUGS.md`, the perf
> record in `docs/CLAUSE_STATUS_LOG.md`.
...
**Corrects the coverage audit.** `docs/coverage-audit/COVERAGE.md` row 1.4 named
...
single-frame features in the master gap matrix `docs/coverage-audit/COVERAGE.md` —
...
matrix is now `docs/coverage-audit/COVERAGE.md`** (the 2026-07-18 synthesis of the three
...
(`docs/coverage-audit/encoder_modules_2026-07-18.md`): the byte-exact LR search (C2, below) existed but
