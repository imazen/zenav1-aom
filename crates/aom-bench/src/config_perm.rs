...
impl CellCtx {
    ...
    pub fn has_partial_sb(self) -> bool {
        !self.w.is_multiple_of(self.sb_px) || !self.h.is_multiple_of(self.sb_px)
    }
}
...
pub fn size_derived(ctx: &CellCtx, speed: i32) -> SizeDerived {
    ...
    SizeDerived {
        ...
        partial_sb_x: !ctx.w.is_multiple_of(ctx.sb_px),
        partial_sb_y: !ctx.h.is_multiple_of(ctx.sb_px),
