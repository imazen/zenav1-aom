...
//!   port verbatim ([`crate::av1_quantize_fp_no_qmatrix`]) — so the
...
/// [`crate::av1_quantize_fp_no_qmatrix`] (the differentially-validated scalar
...
fn quantize_fp_impl_scalar(
    ...
    crate::av1_quantize_fp_no_qmatrix(
...
fn quantize_fp_impl(
    ...
    let rounding = [
        crate::round_power_of_two(round[0] as i32, log_scale),
        crate::round_power_of_two(round[1] as i32, log_scale),
    ];
