...
use aom_dsp::entropy::header::{encode_quantization, QuantParamsHeader};
...
fn encode_loopfilter_matches_c() {
    use aom_dsp::entropy::header::{encode_loopfilter, LoopfilterHeader};
...
fn encode_cdef_matches_c() {
    use aom_dsp::entropy::header::{encode_cdef, CdefHeader};
...
fn encode_segmentation_matches_c() {
    use aom_dsp::entropy::header::{encode_segmentation, SegmentationHeader};
...
fn write_tile_info_matches_c() {
    use aom_dsp::entropy::header::{write_tile_info, TileInfoHeader};
...
fn encode_restoration_mode_matches_c() {
    use aom_dsp::entropy::header::{encode_restoration_mode, RestorationHeader};
...
fn write_delta_q_params_and_tx_mode_match_c() {
    use aom_dsp::entropy::header::{write_delta_q_params, write_tx_mode, DeltaQParams};
...
fn write_film_grain_params_matches_c() {
    use aom_dsp::entropy::header::{write_film_grain_params, FilmGrainParams};
...
fn write_global_motion_matches_c() {
    use aom_dsp::entropy::header::{write_global_motion, WarpedMotionParams};
...
fn write_sequence_header_matches_c() {
    use aom_dsp::entropy::header::{write_sequence_header, SequenceHeaderParams};
...
fn write_ext_tile_info_matches_c() {
    use aom_dsp::entropy::header::write_ext_tile_info;
...
fn write_color_config_matches_c() {
    use aom_dsp::entropy::header::{write_color_config, ColorConfigParams};
...
fn write_frame_header_prefix_matches_c() {
    use aom_dsp::entropy::header::{write_frame_header_prefix, FrameHeaderPrefix};
...
fn write_inter_ref_signaling_matches_c() {
    use aom_dsp::entropy::header::{write_inter_ref_signaling, InterRefSignaling};
...
fn minimal_frame_header_obu() -> aom_dsp::entropy::header::FrameHeaderObu {
    use aom_dsp::entropy::header::*;
...
fn screen_content_key_header_roundtrips_with_intrabc() {
    ...
    use aom_dsp::entropy::header::{read_uncompressed_header, write_frame_header_obu};
...
fn write_tile_group_header_matches_c() {
    use aom_dsp::entropy::header::write_tile_group_header;
    use aom_dsp::entropy::wb::WriteBitBuffer;
