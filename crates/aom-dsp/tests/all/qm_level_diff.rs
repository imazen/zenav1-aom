...
//! [`aom_dsp::quant::aom_get_qmlevel`], [`aom_dsp::quant::aom_get_qmlevel_allintra`],
//! [`aom_dsp::quant::aom_get_qmlevel_luma_ssimulacra2`], and
//! [`aom_dsp::quant::aom_get_qmlevel_444_chroma`] vs the real libaom `static inline`
