...
- **`av1_determine_sc_tools_with_encoding` (encoder_utils.c:1214) — ABSENT (M), the NEXT OPEN
  ...
  `~/tmp/aom_poison_repro/planes_8468.scale59x128.png`). What it needs, in order:
