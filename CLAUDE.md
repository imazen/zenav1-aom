...
2. **Refusals are not divergences and must close.** A configuration a caller can reach must
   ...
   refusal and not a divergence; the harness `aom-bench` may still refuse cells it cannot model.
