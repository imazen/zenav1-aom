...
| (5) match the RD of C | byte identity is the strongest available evidence and holds on 435/435 standalone cells; the pinned divergences are the measured/attributed/bounded residual the directive permits to ship |
...
- **Gate 2 — Encoder:** bitstream bit-identical for every `--cpu-used 0..9`.
  **Scope caveat — SUPERSEDED IN PART 2026-09-02.** The 2026-07-30 caveat read: *"the port
  ...
  the path — **435/435 cells byte-identical to real aomenc** (69/69 when this caveat was
  ...
  `PIN_256x256_speed7`/`PIN_4160x64_multitile_speed9` cells on 2026-09-12, KB-55), both decoders agreeing on the
