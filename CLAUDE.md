...
| KB-P29, KB-13's 2 cpu3-cq63 cells | ~~2 palette 128<sup>2</sup> near-ties~~ (both graduated 2026-08-30 — `text_420_128_cq20` with the KB-41 palette-cost plumbing, `ui_420_128_cq32` with roots #7-#12: they were wrong search costs, not ties); 2 real-content cells | sibling-C RD dump (KB-3/KB-7 method) |
